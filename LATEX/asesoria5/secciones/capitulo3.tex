...
según la Ec.~\eqref{eq:hibrido} del marco teórico. Esa ecuación sustituye a la
Ec.~\eqref{eq:hyperncd3} y es la única
diferencia entre la línea base y el modelo propuesto. Al mover una sola pieza,
cualquier variación de la métrica es atribuible al cambio de representación y no
a diferencias de optimización, de partición o de arquitectura, lo que hace la
ablación interpretable sin ambigüedad.

Aguas abajo de la fusión nada cambia: la afinidad entre prototipos sigue
combinando componente geométrica y semántica según la Ec.~\eqref{eq:afinidad}, y
cada prototipo conserva sus $M=8$ vecinos al construir el hipergrafo.
