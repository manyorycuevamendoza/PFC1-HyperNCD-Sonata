...
% =====================================================================
\section{Análisis de la arquitectura de los componentes}
...
grupos, y no únicamente en las descripciones publicadas. Cuando una cifra se
deriva de forma analítica se indica el procedimiento; cuando depende de una
ejecución todavía no realizada se declara como estimación sujeta a
verificación.

\subsection{Revisión crítica de las implementaciones de referencia}
...
\subsubsection{Sonata: correspondencia entre artículo e implementación}
...
\subsubsection{HyperNCD: discrepancia entre la descripción y el código ejecutado}
...
\subsubsection{Consecuencias para el diseño experimental}
...
\subsection{Análisis de la arquitectura de Sonata}
...
\subsection{Análisis de la arquitectura de HyperNCD}
...
\subsection{Escenarios de ejecución y límites del paralelismo}
...
\subsection{Síntesis del análisis: punto de intervención y atribución}
