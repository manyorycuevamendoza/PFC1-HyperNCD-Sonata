...
% =====================================================================
\section{Análisis de los Componentes}
...
\subsection{Revisión de las Implementaciones de Referencia}
...
\subsubsection{Correspondencia en Sonata}
...
\subsubsection{Discrepancia en HyperNCD}
...
\subsubsection{Consecuencias Metodológicas}
...
\begin{tikzpicture}[
  font=\scriptsize,
  trf/.style={draw, rounded corners, minimum width=7.6cm, minimum height=0.9cm,
              align=center, fill=orange!20},
  cnn/.style={draw, rounded corners, minimum width=7.6cm, minimum height=0.62cm,
              align=center, fill=green!16},
  lin/.style={draw, rounded corners, minimum width=7.6cm, minimum height=0.62cm,
              align=center, fill=blue!14},
  dat/.style={draw, rounded corners, minimum width=7.6cm, minimum height=0.58cm,
...
\draw[{Latex[length=1.4mm]}-{Latex[length=1.4mm]}, black!45]
  ($(e1.east)+(0.4,0.3)$) -- ($(e5.east)+(0.4,-0.3)$);
\node[font=\tiny, text=black!65, rotate=-90]
  at ($(e1.east)!0.5!(e5.east)+(0.72,0)$) {SECUENCIAL};
...
interno a cada capa, en parches y en cabezas, y ya se agota dentro de una sola
...
\subsection{Síntesis y Delimitación del Aporte}
