...
revisión crítica de la literatura, con el análisis de resultados de las cinco
fuentes principales y la declaración de los tres aportes del proyecto, uno por
cada objetivo específico, descompuestos en nueve contribuciones específicas y
cada una nacida de la lectura crítica de un estudio concreto. El
Capítulo~II desarrolla el marco teórico, incluye las fórmulas de
todas las métricas empleadas y cierra con el análisis de la arquitectura de los
dos componentes, del que se derivan el punto exacto de la sustitución, la
justificación de la estrategia de cacheo y los límites del paralelismo. El
Capítulo~III describe el
