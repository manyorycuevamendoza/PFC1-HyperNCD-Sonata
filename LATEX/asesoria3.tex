...
\graphicspath{{images/}} % doble llave: el template original trae una sola y falla
...
\supervisor{Nombres y apellidos de asesor \orcid{0000-0000-0000-0000}}
...
\input{secciones/trabajosFuturos} % sección opcional
